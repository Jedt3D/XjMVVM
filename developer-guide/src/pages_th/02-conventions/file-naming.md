...
description: การตั้งชื่อไฟล์ตามแบบแผนสำหรับไฟล์ ViewModel ไฟล์ Model และเทมเพลต
---
...
ไม่ใช่ทรัพยากรทั้งหมดจำเป็นต้องมีทั้งเจ็ด ทรัพยากรแบบอ่านอย่างเดียวอาจมีเพียง `ListVM` และ `DetailVM` เท่านั้น หน้าที่ไม่ใช่ REST (เช่นหน้าหลักหรือ dashboard) จะได้รับชื่ออธิบายอย่างง่าย: `HomeViewModel.xojo_code`
...
เทมเพลตใช้ชื่อ lowercase `snake_case` และนามสกุล `.html`
...
เมื่อแบบฟอร์มสร้างและแบบฟอร์มแก้ไขเกือบเหมือนกัน ให้ใช้ `form.html` ไฟล์เดี่ยวและสลับไปมาโดยตรวจสอบว่าตัวแปร context มีค่าหรือไม่:
