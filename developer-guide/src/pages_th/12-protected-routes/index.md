...
XjMVVM v1.0.0 นำเสนอฟีเจอร์ที่เกี่ยวข้องกันสองประการ: **เส้นทางที่ปกป้อง** ซึ่งต้องการการยืนยันตัวตน และ **ข้อมูลที่จำกัดต่อผู้ใช้** ที่แยกบันทึกต่อผู้ใช้ รวมกันแล้ว ระบบจึงมั่นใจว่าผู้ใช้จะต้องเข้าสู่ระบบเพื่อเข้าถึงแอปพลิเคชันและสามารถเห็นได้เฉพาะบันทึกของตัวเองเท่านั้น
