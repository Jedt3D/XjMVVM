...
JinjaX เป็น port ของ Jinja2 template engine ที่เขียนด้วย Xojo แบบบริสุทธิ์ มันให้คุณเขียน HTML templates ด้วยไวยากรณ์ที่เข้ากันได้กับ Jinja2 ของ Python — เอนจิ้นเดียวกับที่ใช้โดย Flask และ Django
