...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub DownloadResults()
		  mResultsFile = New WebFile
		  mResultsFile.MIMEType = "text/plain"
		  mResultsFile.ForceDownload = True
		  mResultsFile.Filename = "RegressinatorResults.txt"
	...
	#tag Property, Flags = &h21
		Private mResultsFile As WebFile
	#tag EndProperty
	...
	#tag Enum, Name = TestView, Type = Integer, Flags = &h0
		All
		  Failed
		Passed
	#tag EndEnum
...
#tag Events Toolbar1
	...
	#tag Event
		Sub Opening()
		  ...
		  Var mvvmButton As New WebToolbarButton
		  mvvmButton.Caption = "XjMVVM"
		  mvvmButton.style = WebToolbarButton.ButtonStyles.PushButton
		  Me.AddItem(mvvmButton)
